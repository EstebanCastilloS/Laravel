                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="fotm-group">
                                            ...
                                            <input type="email" name="email" class="form-control" value ="{{ $member->email }}" disabled>
                                            @error('email')
                                    ...
                                    <div class="col-md-6">
                                        <div class="fotm-group">
                                            ...
                                            <input type="text" name="address" class="form-control" value ="{{ $member->address }}"  disabled>
                                            @error('address')
                                    ...
                                    <div class="col-md-6">
                                        <div class="fotm-group">
                                            ...
                                            <input type="date" name="birthdate" class="form-control" value ="{{ $member->birthdate }}" disabled>
                                            @error('birthdate')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="gender" name="gender" class="form-control" disabled>
                                                ...
                                                <option value="Masculino" {{ $member->gender == 'Masculino' ? 'selected' : '' }}>Masculino</option>
                                                <option value="Femenino" {{ $member->gender == 'Femenino' ? 'selected' : '' }}>Femenino</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select id="ministry" name="ministry" class="form-control" disabled>
                                                ...
                                                <option value="Ancianos"{{ $member->ministry == 'Ancianos' ? 'selected' : '' }}>Ancianos</option>
                                                <option value="Adultos"{{ $member->ministry == 'Adultos' ? 'selected' : '' }}>Adultos</option>
                                                <option value="Jovenes"{{ $member->ministry == 'Jovenes' ? 'selected' : '' }}>Jovenes</option>
                                                <option value="Adolescentes"{{ $member->ministry == 'Adolescentes' ? 'selected' : '' }}>Adolescentes</option>
                                                <option value="Niños"{{ $member->ministry == 'Niños' ? 'selected' : '' }}>Niños</option>
                                                <option value="Intercesion"{{ $member->ministry == 'Intercesion' ? 'selected' : '' }}>Intercesion</option>
                                                <option value="Alabanza"{{ $member->ministry == 'Alabanza' ? 'selected' : '' }}>Alabanza</option>
                                                <option value="Danza"{{ $member->ministry == 'Danza' ? 'selected' : '' }}>Danza</option>
                                            </select>
                                            @error('ministry')
                                    ...
                                    <div class="col-md-6">
                                        <div class="fotm-group">
                                            ...
                                            <input type="date" name="date_admission" class="form-control" value ="{{ $member->date_admission }}" disabled>
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-6">
                                            <div class="fotm-group">
                                                ...
                                                <input type="file" name="photo" class="form-control" id="file-input"
                                                    onchange="archivo(event)">
